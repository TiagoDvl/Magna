...
internal class PartidoDao(
    ...
    private val partidoOrdemQueries: PartidoOrdemQueries,
    ...
    override suspend fun setOrdem(partidoIds: List<String>) {
        database.transaction {
            // Cleared first: a party that left the list — the register does retire them —
            // would otherwise keep a position nothing can reach to change.
            partidoOrdemQueries.deletePartidoOrdem()

            partidoIds.forEachIndexed { posicao, partidoId ->
                partidoOrdemQueries.insertPartidoOrdem(partidoId, posicao.toLong())
            }
        }
    }
